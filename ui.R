...
shinyUI(pageWithSidebar(
    ...
    mainPanel(
      h3("Input"),
      h5("You entered father's height and mother's height as "), 
      h5(textOutput("inputValueFather")),
      h5(textOutput("inputValueMother")),
      h5("This implies a midparent height of "),
      h5(textOutput("midParentHeight")),
